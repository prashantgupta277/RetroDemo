...
import './addCustomTemplate.css';
import {create_custom_template} from '../../actions/superAdminTemplateActions';
...
class AddCustomTemplate extends  React.PureComponent {
  ...
  Addtemplate(){
    ...
    let sendRequest={
      "operationName":null,
      "variables":{},
      "query":"mutation {\n  createUserTemplate(userid:\""+userdata.id+"\", templatename: \""+this.state.templatename+"\", category1: \""+this.state.category1+"\", category2: \""+this.state.category2+"\", category3: \""+this.state.category3+"\", category4: \""+this.state.category4+"\") {\n    templatename\n    category1\n    category2\n    category3\n    category4\n  }\n}\n"}
...
function mapDispatchToProps(dispatch) {
  return {
      handleFormSubmit: (data) => dispatch(create_custom_template(data))
  };
}
  
const withConnect = connect(mapStateToProps, mapDispatchToProps);

export default compose(withConnect)(AddCustomTemplate);
